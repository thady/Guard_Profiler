...
public class cr_staff_paye_report : ReportClass {
    
    public cr_staff_paye_report() {
    }
    
    public override string ResourceName {
        get {
            return "cr_staff_paye_report.rpt";
        }
        set {
            // Do nothing
        }
...
public class Cachedcr_staff_paye_report : Component, ICachedReport {
    
    public Cachedcr_staff_paye_report() {
    }
