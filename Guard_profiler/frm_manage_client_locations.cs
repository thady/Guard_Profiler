...
namespace Guard_profiler
{
	public class frm_manage_client_locations : Form
	{
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(frm_manage_client_locations));
			...
			this.txt_location = new TextBox();
			this.txt_client_code = new TextBox();
			this.label3 = new Label();
			this.gdv_client_locations = new DataGridView();
			...
			((ISupportInitialize)this.gdv_client_locations).BeginInit();
			base.SuspendLayout();
			...
			this.panel1.Location = new Point(2, 22);
			this.panel1.Name = "panel1";
			this.panel1.Size = new System.Drawing.Size(537, 332);
			this.panel1.TabIndex = 0;
			this.panel2.BackColor = Color.FromArgb(128, 255, 255);
			this.panel2.Controls.Add(this.gdv_client_locations);
			this.panel2.Location = new Point(3, 55);
			...
			this.label2.Location = new Point(201, 2);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(91, 15);
			this.label2.TabIndex = 17;
			this.label2.Text = "Location Name";
			this.txt_location.Font = new System.Drawing.Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			this.txt_location.Location = new Point(204, 20);
			...
			this.txt_client_code.Location = new Point(427, 0);
			...
			this.label3.Location = new Point(351, 3);
			...
			this.gdv_client_locations.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
			this.gdv_client_locations.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.gdv_client_locations.Location = new Point(3, 3);
			...
			this.gdv_client_locations.CellClick += new DataGridViewCellEventHandler(this.gdv_client_locations_CellClick);
			this.btnsave.BackColor = Color.FromArgb(128, 255, 255);
			this.btnsave.Location = new Point(379, 20);
			...
			this.btnedit.Location = new Point(435, 20);
			...
			this.txt_record_guid.Location = new Point(0, 309);
			...
			this.btnnew.Location = new Point(483, 20);
			...
			base.ClientSize = new System.Drawing.Size(541, 357);
			base.Controls.Add(this.label3);
			base.Controls.Add(this.txt_client_code);
			...
			base.Name = "frm_manage_client_locations";
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "New Securiko Uganda Ltd-Manage Client Locations";
			base.Load += new EventHandler(this.frm_manage_client_locations_Load);
			this.panel1.ResumeLayout(false);
			this.panel1.PerformLayout();
			this.panel2.ResumeLayout(false);
			((ISupportInitialize)this.gdv_client_locations).EndInit();
