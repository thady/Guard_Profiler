...
{
	public class cr_deployment_summary_report : ReportClass
	{
		public override string FullResourceName
		{
			get
			{
				return "Guard_profiler.cr_deployment_summary_report.rpt";
			}
			set
			{
			}
		...
		public override string ResourceName
		{
			get
			{
				return "cr_deployment_summary_report.rpt";
			}
			set
			{
			}
		...
		public cr_deployment_summary_report()
		{
		}
	}
}