...
{
	public class finance_detailed_guard_pay_roll_report : ReportClass
	{
		public override string FullResourceName
		{
			get
			{
				return "Guard_profiler.finance_detailed_guard_pay_roll_report.rpt";
			}
			set
			{
			}
		...
		public override string ResourceName
		{
			get
			{
				return "finance_detailed_guard_pay_roll_report.rpt";
			}
			set
			{
			}
		...
		public finance_detailed_guard_pay_roll_report()
		{
		}
	}
}