...
namespace Guard_profiler.guard_profiles_dbDataSetTableAdapters
{
	...
	public class TableAdapterManager : Component
	{
		...
		private Guard_profiler.guard_profiles_dbDataSetTableAdapters.Tbl_sg_profilesTableAdapter _tbl_sg_profilesTableAdapter;
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public Guard_profiler.guard_profiles_dbDataSetTableAdapters.Tbl_sg_profilesTableAdapter Tbl_sg_profilesTableAdapter
		{
			get
			{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		private int UpdateDeletedRows(guard_profiles_dbDataSet dataSet, List<DataRow> allChangedRows)
		{
			int result = 0;
			if (this._tbl_sg_profilesTableAdapter != null)
			{
