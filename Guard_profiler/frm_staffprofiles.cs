...
namespace Guard_profiler
{
    public partial class frm_staffprofiles : Form
    {
        ...
        protected void save()
        {
            if (lblstaffid.Text == ".")
            {
                StaffProfiles.save_staff_details("save_staff_details", string.Empty, txt_personal_number.Text, cbo_branch.SelectedValue.ToString(), txt_staff_name.Text, cbo_sex.Text, cbo_status.Text, cbo_position.Text, txt_nssf.Text, txt_acc_number.Text, cbo_bank.SelectedValue.ToString(), cbo_bank_branch.SelectedValue.ToString() != "-1" ? cbo_bank_branch.SelectedValue.ToString() : cbo_bank_branch.SelectedValue.ToString(), txt_tin_number.Text, SystemConst._username);
                MessageBox.Show("Success!", "save", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Get_staff_profiles();
            }
            else
            {
                StaffProfiles.save_staff_details("update_staff_details", lblstaffid.Text, txt_personal_number.Text, cbo_branch.SelectedValue.ToString(), txt_staff_name.Text, cbo_sex.Text, cbo_status.Text, cbo_position.Text, txt_nssf.Text, txt_acc_number.Text, cbo_bank.SelectedValue.ToString(), cbo_bank_branch.SelectedValue.ToString() != "-1" ? cbo_bank_branch.SelectedValue.ToString() : cbo_bank_branch.SelectedValue.ToString(), txt_tin_number.Text, SystemConst._username);
        ...
        {
            if (cbo_branch.SelectedValue.ToString() != "-1")
            {
                txt_personal_number.Text = cbo_branch.SelectedValue.ToString() + "-";
            }
        }
