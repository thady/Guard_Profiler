...
{
	public class finance_local_service_tax_report : ReportClass
	{
		public override string FullResourceName
		{
			get
			{
				return "Guard_profiler.finance_local_service_tax_report.rpt";
			}
			set
			{
			}
		...
		public override string ResourceName
		{
			get
			{
				return "finance_local_service_tax_report.rpt";
			}
			set
			{
			}
		...
		public finance_local_service_tax_report()
		{
		}
	}
}