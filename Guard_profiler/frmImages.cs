	...
	public class frmImages : Form
	{
		...
		private void btnSave_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				HeadShotEngine.INSERT_OR_UPDATE_IMAGE("UPDATE_GUARD_HEAD_SHOT", this.lbl_guid.Text, arr);
		...
		private void frmImages_Load(object sender, EventArgs e)
		{
			...
			this.GET_OFFICER_HEADSHOT("SELECT_OFFICER_HEAD_SHOT", this.lbl_guid.Text);
		}
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(frmImages));
			...
			this.lbl_guid.Location = new Point(121, 385);
			...
			this.panel2.BackColor = SystemColors.InactiveBorder;
			this.panel2.Controls.Add(this.picBoxImage);
			this.panel2.Location = new Point(5, 21);
			...
			this.panel3.Location = new Point(5, 207);
			...
			this.picBoxImage.BackColor = SystemColors.Info;
			this.picBoxImage.BorderStyle = BorderStyle.Fixed3D;
			this.picBoxImage.Location = new Point(3, 3);
			this.picBoxImage.Name = "picBoxImage";
			this.picBoxImage.Size = new System.Drawing.Size(214, 155);
			this.picBoxImage.SizeMode = PictureBoxSizeMode.AutoSize;
			this.picBoxImage.TabIndex = 0;
			this.picBoxImage.TabStop = false;
			base.AutoScaleDimensions = new SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.BackColor = Color.FromArgb(255, 192, 128);
			base.ClientSize = new System.Drawing.Size(649, 410);
			...
			base.Load += new EventHandler(this.frmImages_Load);
