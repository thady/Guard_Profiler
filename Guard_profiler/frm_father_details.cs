...
{
	public class frm_father_details : Form
	{
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(frm_father_details));
			...
			this.panel4.Location = new Point(1, 4);
...
//			items.AddRange(objArray);
			...
			this.btnEdit.Location = new Point(484, 529);
			...
			this.btnsave.Location = new Point(601, 528);
			...
			base.ClientSize = new System.Drawing.Size(730, 575);
			...
			base.Name = "frm_father_details";
			base.StartPosition = FormStartPosition.CenterScreen;
			this.Text = "FATHER'S DETAILS";
			base.Load += new EventHandler(this.frm_father_details_Load);
		...
		protected void RETURN_GUARD_DETAILS(string guard_number)
		{
			...
			{
				DataRow dtRow = dt.Rows[0];
				this.txt_adress.Text = (dtRow["father_name_and_adress"] != DBNull.Value ? (string)dtRow["father_name_and_adress"] : string.Empty);
				this.cbo_district.Text = (dtRow["father_district"] != DBNull.Value ? (string)dtRow["father_district"] : string.Empty);
				this.txt_county.Text = (dtRow["father_county"] != DBNull.Value ? (string)dtRow["father_county"] : string.Empty);
				this.txt_sub_county.Text = (dtRow["father_sub_county"] != DBNull.Value ? (string)dtRow["father_sub_county"] : string.Empty);
				this.txt_parish.Text = (dtRow["father_parish"] != DBNull.Value ? (string)dtRow["father_parish"] : string.Empty);
				this.txt_village.Text = (dtRow["father_village"] != DBNull.Value ? (string)dtRow["father_village"] : string.Empty);
				this.txt_zone.Text = (dtRow["father_zone"] != DBNull.Value ? (string)dtRow["father_zone"] : string.Empty);
				this.txt_lc1_chairperson_name.Text = (dtRow["father_lc1_chairperson"] != DBNull.Value ? (string)dtRow["father_lc1_chairperson"] : string.Empty);
				this.txt_lc1_chairperson_phone.Text = (dtRow["father_lc1_chairperson_phone"] != DBNull.Value ? (string)dtRow["father_lc1_chairperson_phone"] : string.Empty);
				this.txt_neighbor_name.Text = (dtRow["father_village_neighbor_name"] != DBNull.Value ? (string)dtRow["father_village_neighbor_name"] : string.Empty);
				this.txt_neighbor_phone.Text = (dtRow["father_village_neighbor_phone"] != DBNull.Value ? (string)dtRow["father_village_neighbor_phone"] : string.Empty);
