...
namespace Guard_profiler.dt_set_sg_profile_singleTableAdapters
{
	...
	public class Tbl_sg_profilesTableAdapter : Component
	{
		...
		private void InitAdapter()
		{
			...
			this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@record_guid", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "record_guid", DataRowVersion.Current, false, null, "", "", ""));
		...
		public virtual int Insert(string record_guid, string full_name, string phone, string branch, string position, string department, DateTime? registered_date, string birth_place, DateTime? dob, int? age, string gender, string home_district, string home_county, string home_sub_county, string home_parish, string home_village_lc1, string religion, string marital_status, string partners_name, string current_residence_district, string current_residence_sub_county, string current_residence_parish, string current_residence_zone, string current_landlord_name, string father_name, string father_district, string father_county, string father_village, string father_zone, string prev_employer_name, string prev_employer_address, string cause_of_departure, string tin_number, string previous_salary, DateTime? start_date, string institution_name, string award_name, DateTime? study_start_date, DateTime? study_end_date, string refferees, byte[] image_data)
		{
			...
			if (full_name != null)
			{
				this.Adapter.InsertCommand.Parameters[1].Value = full_name;
			}
			else
			{
			...
			if (phone != null)
			{
				this.Adapter.InsertCommand.Parameters[2].Value = phone;
			}
			else
			{
			...
			if (branch != null)
			{
				this.Adapter.InsertCommand.Parameters[3].Value = branch;
			}
			else
			{
			...
			if (position != null)
			{
				this.Adapter.InsertCommand.Parameters[4].Value = position;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[6].Value = registered_date.Value;
			}
			if (birth_place != null)
			{
				this.Adapter.InsertCommand.Parameters[7].Value = birth_place;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[8].Value = dob.Value;
			}
			if (!age.HasValue)
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[9].Value = age.Value;
			}
			if (gender != null)
			{
				this.Adapter.InsertCommand.Parameters[10].Value = gender;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[11].Value = home_district;
			}
			else
			{
			...
			if (home_county != null)
			{
				this.Adapter.InsertCommand.Parameters[12].Value = home_county;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[13].Value = home_sub_county;
			}
			else
			{
			...
			if (home_parish != null)
			{
				this.Adapter.InsertCommand.Parameters[14].Value = home_parish;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[15].Value = home_village_lc1;
			}
			else
			{
			...
			if (religion != null)
			{
				this.Adapter.InsertCommand.Parameters[16].Value = religion;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[17].Value = marital_status;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[18].Value = partners_name;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[19].Value = current_residence_district;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[20].Value = current_residence_sub_county;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[21].Value = current_residence_parish;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[22].Value = current_residence_zone;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[23].Value = current_landlord_name;
			}
			else
			{
			...
			if (father_name != null)
			{
				this.Adapter.InsertCommand.Parameters[24].Value = father_name;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[25].Value = father_district;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[26].Value = father_county;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[27].Value = father_village;
			}
			else
			{
			...
			if (father_zone != null)
			{
				this.Adapter.InsertCommand.Parameters[28].Value = father_zone;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[29].Value = prev_employer_name;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[30].Value = prev_employer_address;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[31].Value = cause_of_departure;
			}
			else
			{
			...
			if (tin_number != null)
			{
				this.Adapter.InsertCommand.Parameters[32].Value = tin_number;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[33].Value = previous_salary;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[34].Value = start_date.Value;
			}
			if (institution_name != null)
			{
				this.Adapter.InsertCommand.Parameters[35].Value = institution_name;
			}
			else
			{
			...
			if (award_name != null)
			{
				this.Adapter.InsertCommand.Parameters[36].Value = award_name;
			}
			else
			{
			...
			{
				this.Adapter.InsertCommand.Parameters[37].Value = study_start_date.Value;
			}
			...
			{
				this.Adapter.InsertCommand.Parameters[38].Value = study_end_date.Value;
			}
			if (refferees != null)
			{
				this.Adapter.InsertCommand.Parameters[39].Value = refferees;
			}
			else
			{
			...
			if (image_data != null)
			{
				this.Adapter.InsertCommand.Parameters[40].Value = image_data;
			}
			else
			{
