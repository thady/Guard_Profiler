...
{
	public class finance_employee_paye_report : ReportClass
	{
		public override string FullResourceName
		{
			get
			{
				return "Guard_profiler.finance_employee_paye_report.rpt";
			}
			set
			{
			}
		...
		public override string ResourceName
		{
			get
			{
				return "finance_employee_paye_report.rpt";
			}
			set
			{
			}
		...
		public finance_employee_paye_report()
		{
		}
	}
}